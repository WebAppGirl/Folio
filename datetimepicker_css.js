...
var WeekDayColor="00CCCC";//Background color of weekdays.
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" background='sample/"+ThemeBg+"' border=1 cellpadding=1 cellspacing=1 width='200px' valign='top'>\n";
  ...
  //******************End Month and Year selector in arrow******************************
	...
	// determines if there is enoug  space to open the cal above the position where it is called
	if (ypos > calHeight) {
	   ypos = ypos - calHeight; 
	}
